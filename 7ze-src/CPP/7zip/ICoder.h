...
namespace NCoderPropID
{
  enum EEnum
  {
    ...
    kLibbscBlockSorter,
    kLibbscCoder,
    kLibbscSortingContexts,
    kLibbscEnableParallelProcessing,
//     kLibbscEnableMultiThreading,
    kLibbscEnableFastMode,
    kLibbscEnableLargePages,
    kLibbscEnableCUDA,
    kLibbscEnableSegmentation,
    kLibbscEnableReordering,
    kLibbscEnableLZP,
    kLibbscLZPHashSize,
    kLibbscLZPMinLen,
    kCsc32M,
