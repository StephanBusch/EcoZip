...
// define FORMAT_7ZE_RECOVERY if you want to recover multivolume archives with empty StartHeader
#ifndef _SFX
#define FORMAT_7ZE_RECOVERY
#endif
...
#define CHECK_SIGNATURE if (p[0] != '7' || p[1] != 'z' || p[2] != 'e' || p[3] != 0xAF || p[4] != 0x27 || p[5] != 0x1C) return false;
