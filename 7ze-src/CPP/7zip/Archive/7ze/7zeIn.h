...
#ifdef _NO_CRYPTO
#define _7ZE_DECODER_CRYPRO_VARS_DECL
#define _7ZE_DECODER_CRYPRO_VARS
#else
#define _7ZE_DECODER_CRYPRO_VARS_DECL , ICryptoGetTextPassword *getTextPassword, bool &isEncrypted, bool &passwordIsDefined, UString &password
#define _7ZE_DECODER_CRYPRO_VARS , getTextPassword, isEncrypted, passwordIsDefined, password
#endif
