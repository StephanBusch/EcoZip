...
static LPCTSTR k_ShellExtName = TEXT("EcoZip Shell Extension");
...
static LPCTSTR k_KeyPostfix_ContextMenu = TEXT("\\shellex\\ContextMenuHandlers\\EcoZip");
static LPCTSTR k_KeyPostfix_DragDrop    = TEXT("\\shellex\\DragDropHandlers\\EcoZip");
