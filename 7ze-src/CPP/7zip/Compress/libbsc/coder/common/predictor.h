...
public:
    ...
    {
        probability = (short)(probability + (((4096 - threshold - probability) * adaptationRate) >> 12));
    };

    static INLINE void UpdateBit1(short & probability, const int threshold, const int adaptationRate)
    {
        probability = (short)(probability - (((probability - threshold) * adaptationRate) >> 12));
    };
...
public:
    ...
    INLINE void Init()
    {
        ...
        for (int p = 0; p < 17; ++p)
        {
            probabilityMap[p] = (short)(bsc_squash((p - 8) * 256));
        }
    }

    INLINE int Mixup(const int probability0, const int probability1, const int probability2)
    {
        stretchedProbability0 = (short)bsc_stretch(probability0);
        stretchedProbability1 = (short)bsc_stretch(probability1);
        stretchedProbability2 = (short)bsc_stretch(probability2);
    ...
    {
        const short stretchedProbability0 = (short)bsc_stretch(probability0);
        const short stretchedProbability1 = (short)bsc_stretch(probability1);
        const short stretchedProbability2 = (short)bsc_stretch(probability2);
