...
public:
	...
	DWORD SetBitmaps(int nBitmapIn, COLORREF crTransColorIn = 0, int nBitmapOut = NULL, COLORREF crTransColorOut = 0, BOOL bMaskNeed = FALSE);
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn = 0, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0, BOOL bMaskNeed = FALSE);
	DWORD SetPNGBitmaps(int nBitmapIn, COLORREF crTransColorIn = 0, int nBitmapOut = NULL, COLORREF crTransColorOut = 0, BOOL bMaskNeed = FALSE);

	void SizeToContent();

#ifdef	BTNST_USE_BCMENU
	DWORD SetMenu(UINT nMenu, HWND hParentWnd, UINT nToolbarID = NULL, CSize sizeToolbarIcon = CSize(16, 16), COLORREF crToolbarBk = RGB(255, 0, 255), BOOL bRepaint = TRUE);
#else
...
#pragma pack(1)
	typedef struct _STRUCT_BITMAPS
	{
		...
		HBITMAP		hBitmapOpaque;	// Handle to bitmap with Opaque pixels only
