...
// CEcoZipFMDlg dialog
class CEcoZipFMDlg : public CFileManagerDlg
{
  friend CDropTarget;
  // Construction
public:
  CEcoZipFMDlg(CWnd* pParent = NULL);	// standard constructor
  virtual ~CEcoZipFMDlg();

  // Dialog Data
  enum { IDD = IDD_ECOZIPFM_DIALOG };
