...
#ifdef USE_WIN_PATHS
#include "CPP/7zip/UI/FileManager/NetFolder.h"
#include "CPP/7zip/UI/FileManager/FSDrives.h"
#include "CPP/7zip/UI/FileManager/AltStreamsFolder.h"
#endif
...
{
	iconIndex = GetIconIndexForCSIDL(CSIDL_DESKTOPDIRECTORY);
	return LangString(IDS_DESKTOP);
}
...
UString GetSpecialFolderPath(int csidl)
{
  UString us;
  WCHAR s[MAX_PATH + 1];
...
{
  return GetSpecialFolderPath(CSIDL_PERSONAL);
}
