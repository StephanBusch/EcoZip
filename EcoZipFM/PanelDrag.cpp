...
static LPCTSTR kSvenZipSetFolderFormat = TEXT("EcoZip::SetTargetFolder");
...
STDMETHODIMP CDropSource::QueryContinueDrag(BOOL escapePressed, DWORD keyState)
{
  ...
  if ((keyState & MK_LBUTTON) == 0)
  {
    ...
    if (needExtract)
    {
      ...
      // If you know better way to solve the problem, please notify EcoZip developer.
...
{
  CContentsView *panel = ((CEcoZipFMDlg *)m_pWindow)->m_pContentsView;
