...
// EcoZipFMDlg.cpp : implementation file
//
...
BOOL CAboutDlg::OnInitDialog()
{
  ...
  UString s = L"EcoZip " LLL(MY_VERSION);
#ifdef MY_CPU_64BIT
  s += L" [";
...
CEcoZipFMDlg::CEcoZipFMDlg(CWnd* pParent /*=NULL*/)
  : CFileManagerDlg(CEcoZipFMDlg::IDD, pParent)
  ...
  , m_nContentsViewStyle(3)
{
  ...
  static UINT nButtonIDs[] = {
    ...
    IDS_BUTTON_BENCHMARK, IDB_BENCHMARK, IDB_BENCHMARK_H,
...
CEcoZipFMDlg::~CEcoZipFMDlg()
{
}


void CEcoZipFMDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CEcoZipFMDlg, CFileManagerDlg)
  ON_WM_CREATE()
  ON_WM_ENTERSIZEMOVE()
  ON_WM_EXITSIZEMOVE()
  ON_WM_SYSCOMMAND()
  ON_UPDATE_COMMAND_UI_RANGE(HISTORY_CMD_FIRST, HISTORY_CMD_LAST, &CEcoZipFMDlg::OnUpdateHistory)
  ON_BN_CLICKED(IDC_BTN_MENU, &CEcoZipFMDlg::OnBnClickedBtnMenu)
  ON_BN_CLICKED(IDC_BTN_SKIN, &CEcoZipFMDlg::OnBnClickedBtnSkin)
  ON_BN_CLICKED(IDC_BTN_MINIMIZE, &CEcoZipFMDlg::OnBnClickedBtnMinimize)
  ON_BN_CLICKED(IDC_BTN_MAXIMIZE, &CEcoZipFMDlg::OnBnClickedBtnMaximize)
  ON_BN_CLICKED(IDC_BTN_CLOSE, &CEcoZipFMDlg::OnBnClickedBtnClose)

  ON_UPDATE_COMMAND_UI_RANGE(IDC_BTN_ADD_TO_ARCHIVE, IDC_BTN_PROPERTIES, &CEcoZipFMDlg::OnUpdateItemSelected)
  ON_UPDATE_COMMAND_UI_RANGE(ID_7ZE_OPEN_ARCHIVE, ID_7ZE_COMPRESS_AND_EMAIL, &CEcoZipFMDlg::OnUpdateItemSelected)
  ON_UPDATE_COMMAND_UI_RANGE(ID_FILE_OPEN_INSIDE, ID_FILE_COMMENT, &CEcoZipFMDlg::OnUpdateItemSelected)
  ON_UPDATE_COMMAND_UI(ID_EDIT_DESELECT_ALL, &CEcoZipFMDlg::OnUpdateItemSelected)
  ON_UPDATE_COMMAND_UI(ID_EDIT_DESELECT_WITH_MASK, &CEcoZipFMDlg::OnUpdateItemSelected)
  ON_UPDATE_COMMAND_UI(ID_EDIT_DESELECT_BY_TYPE, &CEcoZipFMDlg::OnUpdateItemSelected)
  ON_UPDATE_COMMAND_UI_RANGE(IDC_BTN_NAV_BACKWARD, IDC_BTN_NAV_FORWARD, &CEcoZipFMDlg::OnUpdateRange)
  ON_UPDATE_COMMAND_UI(IDC_BTN_NAV_BACK_TO, &CEcoZipFMDlg::OnUpdateRange)
  ON_UPDATE_COMMAND_UI(IDC_BTN_NAV_UP, &CEcoZipFMDlg::OnUpdateRange)
  ON_UPDATE_COMMAND_UI(ID_VIEW_AUTO_REFRESH, &CEcoZipFMDlg::OnUpdateRange)

  ON_COMMAND_RANGE(IDM_ABOUTBOX, IDM_ABOUTBOX, &CEcoZipFMDlg::OnCommandRange)
  ON_COMMAND_RANGE(ID_APP_ABOUT, ID_APP_ABOUT, &CEcoZipFMDlg::OnCommandRange)
  ON_COMMAND_RANGE(ID_MENU_BEGIN, ID_MENU_END, &CEcoZipFMDlg::OnCommandRange)
  ON_COMMAND_RANGE(ID_EDIT_SELECT_ALL, ID_EDIT_SELECT_ALL, &CEcoZipFMDlg::OnCommandRange)
  ON_COMMAND_RANGE(IDC_BTN_ADD_TO_ARCHIVE, IDC_BTN_BENCHMARK, &CEcoZipFMDlg::OnCommandRange)
  ON_COMMAND_RANGE(IDC_BTN_BENCHMARK, IDC_BTN_BENCHMARK, &CEcoZipFMDlg::OnCommandRange)
  ON_COMMAND_RANGE(IDC_BTN_NAV_BACKWARD, IDC_BTN_NAV_FORWARD, &CEcoZipFMDlg::OnCommandRange)
  ON_COMMAND_RANGE(IDC_BTN_NAV_UP, IDC_BTN_NAV_UP, &CEcoZipFMDlg::OnCommandRange)

  ON_WM_CONTEXTMENU()

  ON_BN_CLICKED(IDC_BTN_NAV_BACK_TO, &CEcoZipFMDlg::OnBnClickedBtnNavBackTo)
  ON_BN_CLICKED(IDC_BTN_SWITCH_VIEW_STYLE, &CEcoZipFMDlg::OnBnClickedBtnSwitchViewStyle)
  ON_BN_CLICKED(IDC_BTN_VIEW_STYLE, &CEcoZipFMDlg::OnBnClickedBtnViewStyle)
  ON_UPDATE_COMMAND_UI_RANGE(ID_VIEW_SMALLICON, ID_VIEW_DETAILS, &CEcoZipFMDlg::OnUpdateViewStyle)
  ON_COMMAND_RANGE(ID_VIEW_SMALLICON, ID_VIEW_DETAILS, &CEcoZipFMDlg::OnViewStyle)
  ON_UPDATE_COMMAND_UI_RANGE(ID_VIEW_ARRANGE_BY_NAME, ID_VIEW_ARRANGE_NO_SORT, &CEcoZipFMDlg::OnUpdateViewArrange)

  ON_COMMAND(ID_CMB_DROPDOWN, &CEcoZipFMDlg::OnCmbDropdown)
  ON_NOTIFY(CBEN_ENDEDIT, IDC_CMB_PATH, &CEcoZipFMDlg::OnCbenEndeditCmbPath)
  ON_CBN_DROPDOWN(IDC_CMB_PATH, &CEcoZipFMDlg::OnCbnDropdownCmbPath)
  ON_CBN_SELENDOK(IDC_CMB_PATH, &CEcoZipFMDlg::OnCbnSelendokCmbPath)
  ON_MESSAGE(kFolderChanged, &CEcoZipFMDlg::OnFolderChanged)
  ON_COMMAND(ID_NEXT_PANE, &CEcoZipFMDlg::OnNextPane)
  ON_COMMAND(ID_TOOLS_OPTIONS, &CEcoZipFMDlg::OnToolsOptions)
  ON_MESSAGE(kRefresh_StatusBar, &CEcoZipFMDlg::OnRefresh_StatusBar)
END_MESSAGE_MAP()


// CEcoZipFMDlg message handlers
...
int CEcoZipFMDlg::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
BOOL CEcoZipFMDlg::OnInitDialog()
{
...
CPoint CEcoZipFMDlg::GetLogoPos()
{
  BITMAP bmTop, bmLogo;
...
void CEcoZipFMDlg::OnEnterSizeMove()
{
...
void CEcoZipFMDlg::OnExitSizeMove()
{
...
void CEcoZipFMDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CEcoZipFMDlg::SetDCClipArea(CDC *pDC)
{
  // 	CRect rt;
  // 	GetClientRect(&rt);
...
void CEcoZipFMDlg::GetSysMenuRect(LPRECT lpRect)
{
  GetDlgItem(IDC_PIC_SYSMENU)->GetWindowRect(lpRect);
}


void CEcoZipFMDlg::GetButtons(CButtonST **&pButtons, UINT &nButtons)
{
...
void CEcoZipFMDlg::GetSystemButtons(CButton **&pButtons, UINT &nButtons)
{
...
BOOL CEcoZipFMDlg::PreTranslateMessage(MSG* pMsg)
{
...
void CEcoZipFMDlg::GetToolButtons(CButton **&pButtons, UINT &nButtons)
{
...
void CEcoZipFMDlg::GetNavControls(CWnd **&pControls, UINT &nControls)
{
...
CFrameWnd * CEcoZipFMDlg::GetCenterFrame()
{
  return m_pFrameWnd;
}


CStatusBar *CEcoZipFMDlg::GetStatusBar()
{
  return &m_wndStatusBar;
}


void CEcoZipFMDlg::ArrangeControls()
{
  ...
  m_btnMenu.SetWindowPos(NULL,
    rtClient.Width() - rt.Width() * 1 - xMargin * 2,
    yMargin + rt.Height() * 2, 0, 0, SWP_NOZORDER | SWP_NOSIZE);
...
void CEcoZipFMDlg::OnOK()
{

}


void CEcoZipFMDlg::OnCancel()
{
...
void CEcoZipFMDlg::OnBnClickedBtnMenu()
{
#if _DEBUG
  //   CProgressDialog dlg;
  //   dlg.DoModal();
...
void CEcoZipFMDlg::OnBnClickedBtnSkin()
{
  CProgressDialog dlg;
  dlg.DoModal();
}
...
void CEcoZipFMDlg::OnBnClickedBtnMinimize()
{
  CPoint point;
  GetCursorPos(&point);
...
void CEcoZipFMDlg::OnBnClickedBtnMaximize()
{
  CPoint point;
  GetCursorPos(&point);
...
void CEcoZipFMDlg::OnBnClickedBtnClose()
{
  CPoint point;
  GetCursorPos(&point);
...
void CEcoZipFMDlg::OnUpdateItemSelected(CCmdUI *pCmdUI)
{
...
void CEcoZipFMDlg::OnUpdateRange(CCmdUI *pCmdUI)
{
  switch (pCmdUI->m_nID)
  {
...
void CEcoZipFMDlg::OnCommandRange(UINT nID)
{
  CWnd *pWndFocused = CWnd::GetFocus();
  switch (nID)
  {
...
void CEcoZipFMDlg::OnContextMenu(CWnd* pWnd, CPoint point)
{
  // TODO: Add your message handler code here
}


void CEcoZipFMDlg::OnUpdateHistory(CCmdUI *pCmdUI)
{
  pCmdUI->Enable(pCmdUI->m_nID - HISTORY_CMD_FIRST <= (int)m_vecHistories.Size());
}


void CEcoZipFMDlg::OnBnClickedBtnNavBackTo()
{
  CRect rt;
...
void CEcoZipFMDlg::OnBnClickedBtnSwitchViewStyle()
{
...
void CEcoZipFMDlg::OnBnClickedBtnViewStyle()
{
  CRect rt;
...
void CEcoZipFMDlg::OnUpdateViewStyle(CCmdUI *pCmdUI)
{
  pCmdUI->SetCheck(pCmdUI->m_nID - ID_VIEW_SMALLICON == m_nContentsViewStyle);
}


void CEcoZipFMDlg::OnViewStyle(UINT nID)
{
...
void CEcoZipFMDlg::OnUpdateViewArrange(CCmdUI *pCmdUI)
{
  pCmdUI->SetRadio(
...
void CEcoZipFMDlg::OnCmbDropdown()
{
  m_bTracking = TRUE;
  m_cmbPath.SetFocus();
...
void CEcoZipFMDlg::OnCbenEndeditCmbPath(NMHDR *pNMHDR, LRESULT *pResult)
{
  if (m_bTracking)
    return;
...
void CEcoZipFMDlg::AddComboBoxItem(
...
void CEcoZipFMDlg::OnCbnDropdownCmbPath()
{
  m_vecPaths.Clear();
  ...
  FOR_VECTOR(i, driveStrings)
  {
    ...
    AddComboBoxItem(s, iconIndex2, 1, false);
  }
...
void CEcoZipFMDlg::OnCbnSelendokCmbPath()
{
...
LRESULT CEcoZipFMDlg::OnFolderChanged(WPARAM wParam, LPARAM lParam)
{
  if (m_bTracking)
    return 0;
  m_bTracking = TRUE;
...
void CEcoZipFMDlg::UpdateFolder(
...
LRESULT CEcoZipFMDlg::OnRefresh_StatusBar(WPARAM wParam, LPARAM lParam)
{
...
void CEcoZipFMDlg::Refresh_StatusBar()
{
  /*
  g_name_cnt++;
  char s[256];
