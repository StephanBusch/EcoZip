...
---------------
  ...
  There are two types of executables in EcoZip:
  ...
  2) Standalone modules are compiled without EXTERNAL_CODECS:
    ...
    - standalone versions of console EcoZip: 7za.exe, 7zr.exe
...
public:
  ...
  HRESULT Load();
#ifdef EXTERNAL_CODECS
  HRESULT LoadExternalCodecs(FString &baseFolder, FStringVector &codecDlls);
#endif
