...
{
  MessageBoxError(errorCode, L"EcoZip");
}
...
{
  return GetFolderTypeID().IsPrefixedBy_Ascii_NoCase("EcoZip");
}
...
void CContentsView::TestArchives()
{
  ...
  if (archiveFolder)
  {
    ...
    UString progressWindowTitle = L"EcoZip"; // LangString(IDS_APP_TITLE);
