...
void CContentsView::SetSortRawStatus()
{
...
int CALLBACK CompareItems2(LPARAM lParam1, LPARAM lParam2, LPARAM lpData)
{
  if (lpData == 0)
    return 0;
  CContentsView *panel = (CContentsView *)lpData;
...
/*
void CContentsView::SortItems(int index)
{
  if (index == _sortIndex)
...
void CContentsView::SortItemsWithPropID(PROPID propID)
{
...
void CContentsView::OnLvnColumnclick(NMHDR *pNMHDR, LRESULT *pResult)
{
