    ...
    Int32 *answer)
{
  ...
  switch (writeAnswer)
  {
    ...
    case IDC_YES_TO_ALL:  *answer = NOverwriteAnswer::kYesToAll; break;
    case IDC_NO_TO_ALL:   *answer = NOverwriteAnswer::kNoToAll; break;
    case IDC_AUTO_RENAME: *answer = NOverwriteAnswer::kAutoRename; break;
